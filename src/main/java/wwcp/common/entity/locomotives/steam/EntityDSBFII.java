...
public class EntityDSBFII extends SteamTrain {
    ...
    public EntityDSBFII(World world) {
        ...
        InsertTexture(2, "DSB F II High coal bunker");
    ...
    public void onRenderInsertRecord() {
        Traincraft.traincraftRegistry.RegisterRollingStockModel(
                new TrainRenderRecord(wwcp.common.library.Info.modID,
                        ...
                        "DSB F II",
                        new float[]{-1.035f,0.15F,0.0F},
                        new float[]{0F, 180F, 180F},

                        null, "largesmoke", new ArrayList<double[]>() { {add(new double[] { 2.535D, 1.5D, 0.0D }); }},
                        "explode", new ArrayList<double[]>() { { add(new double[] { 2.335D, -0.1875D, 0.6875D }); }}, 10, 2)
